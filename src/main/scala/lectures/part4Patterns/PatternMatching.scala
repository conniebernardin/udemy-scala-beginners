...
object PatternMatching extends App{
  ...
  val greeting = bob match {
    //provide pattern instead of value (n,a)
    case Person(n, a) if a < 21 => s"Hi, my name is $n and I can't drink in the US" //if statement is a guard
  ...
  // The case above is overkill: WHY?!
